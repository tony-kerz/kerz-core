...
// */
//package com.kerz.validation.engine.resolver;
//
...
//      Class<? extends TraversableResolver> jpaAwareResolverClass = (Class<? extends TraversableResolver>) loadClass(
...
//    catch (ValidationException e)
//    {
//      log.info("Unable to load or instanciate JPA aware resolver {}. All properties will per default be traversable.",
...
//        || (traversableProperty.getName() == null) // tlk...
//        || jpaTraversableResolver.isReachable(traversableObject, traversableProperty, rootBeanType,
...
//  {
//    return jpaTraversableResolver == null
//        || jpaTraversableResolver.isCascadable(traversableObject, traversableProperty, rootBeanType,
//            pathToTraversableObject, elementType);
//  }
//}
